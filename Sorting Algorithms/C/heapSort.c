/*
	Program : Implementation of Heap Sort Algorithm in C
	...
	Instructions:
		- This is just the sole heapSort.c file. Compile it using command line with the provided program.c file
